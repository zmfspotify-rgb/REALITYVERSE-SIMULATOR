...
To proceed:
- Create and add the Unreal project content to this repo (e.g., `Source/`, `Content/Shows/LoveIsland/`, `Recording/`, `Launch/launch.bat`).
- Reference an installed Unreal Engine 5.3+ externally instead of committing engine binaries.
- Once the project and assets exist here, we can automate builds/tests and iterate on the required gameplay systems.
