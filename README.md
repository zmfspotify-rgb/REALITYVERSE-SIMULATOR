...
To proceed, first create and add the Unreal project content to this repo (e.g., `Source/`, `Content/Shows/LoveIsland/`, `Recording/`, `Launch/launch.bat`) while referencing an installed Unreal Engine 5.3+ externally. Once the project and assets exist here, we can automate builds/tests and iterate on the required gameplay systems.
